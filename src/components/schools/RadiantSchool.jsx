...
const RadiantSchool = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full overflow-x-hidden">
      <div className="flex flex-col items-center w-full max-w-screen-lg mt-8 px-4 md:px-12">
        <Slider {...settings} className="w-full">
          <div className="relative w-full h-64 overflow-hidden">
            <img
              className="w-full h-full object-cover"
              src="https://wikiwandv2-19431.kxcdn.com/_next/image?url=https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/RHSSBKN.jpg/640px-RHSSBKN.jpg&w=640&q=50"
          ...
          <div className="relative w-full h-64 overflow-hidden">
            <img
              className="w-full h-full object-cover"
              src="https://i.pinimg.com/originals/03/2f/62/032f62abd9ae48dcf14d10d2b9909c81.jpg"
              alt="Radiant Secondary School"
            />
            <div className="absolute inset-0 bg-black bg-opacity-20"></div>
          </div>
          <div className="relative w-full h-64 overflow-hidden">
            <img
              className="w-full h-full object-cover"
              src="https://theedunepal.ap-south-1.linodeobjects.com/uploads/clients/radiantsecondaryschool/banner/94866107_104168927947814_936785904024944640_o.jpg"
              alt="Radiant Secondary School"
            />
            <div className="absolute inset-0 bg-black bg-opacity-20"></div>
          </div>
        ...
        <div className="w-full p-4 my-4 bg-white rounded shadow-md hover:shadow-lg transform hover:-translate-y-1 transition">
