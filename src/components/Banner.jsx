...
const Banner = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-4  ">
      <div className="container mx-auto text-center">
        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
  <div className="flex-grow mb-4 sm:mb-0 sm:mr-2">
    <select
      className="p-3 bg-[#00274D] text-white font-semibold rounded-lg outline-none w-full"
  ...
  <div className="flex-grow mb-4 sm:mb-0 sm:mr-2">
    <input
      ...
      onChange={(e) => setSelectedSchool(e.target.value)}
      className="p-3 text-gray-600 outline-none w-full"
      style={{
        borderRadius: '0.5rem',
  ...
  <button
    onClick={handleFind}
    className="p-3 bg-[#00274D] text-white font-semibold rounded-lg w-full sm:w-auto"
    style={{
      borderRadius: '0.5rem',
      boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)',
    }}
